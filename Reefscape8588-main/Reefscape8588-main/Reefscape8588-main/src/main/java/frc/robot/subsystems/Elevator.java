...
public class Elevator extends SubsystemBase {
    ...
    private RelativeEncoder m_encoder = m_elevatorMotorLeft.getEncoder();
    ...
    double voltsOut = MathUtil.clamp(
        m_elevatorLeftController.calculate(getHeightMeters(), goal) + 7/*Feed forward meant to replace 7 don't know how to do that */, -12, 12); // 7 is the max voltage to send out.
